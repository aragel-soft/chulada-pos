...
-- ITEM 6: NORMAL (Rimel)
INSERT INTO sale_items (id, sale_id, product_id, product_name, product_code, quantity, unit_price, price_type, subtotal) VALUES
('si-test-24', 'sale-test-return-005', 'p099', 'Pintalabios Mágico Marroquí (Verde a Rosa)', 'PINTA-LAB', 2, 15.00, 'retail', 30.00);
...
INSERT INTO sale_items (id, sale_id, product_id, product_name, product_code, quantity, unit_price, price_type, subtotal) VALUES
('si-test-29', 'sale-test-return-007', 'p091', 'Shampoo Sin Sulfatos Cabello Teñido 1L', 'SHAMP-SUL', 1, 180.00, 'retail', 180.00),
('si-test-30', 'sale-test-return-007', 'p092', 'Acondicionador Sin Sulfatos Cabello Teñido 1L', 'ACOND-SUL', 1, 180.00, 'retail', 180.00),
('si-test-31', 'sale-test-return-007', 'p093', 'Termoprotector Capilar Spray 250ml', 'TERM-PROT', 1, 95.00, 'retail', 95.00),
('si-test-32', 'sale-test-return-007', 'p094', 'Gotas de Seda Bio Elixir 60ml', 'GOTA-SEDA', 1, 55.00, 'retail', 55.00);

    ...
    <div className="flex flex-col gap-4 pt-4 h-full overflow-auto">
      ...
      <div className="flex-1 min-h-0 flex flex-col">
        <div className="flex items-center justify-between mb-2">
          <h2 className="text-lg font-semibold print:hidden">Productos Bajos de Inventario</h2>
          <Button
            variant="outline"
            size="sm"
            onClick={handlePrint}
        ...
        <div className="hidden print:block mb-4">
          <h1 className="text-xl font-bold text-center">Reporte de Reabastecimiento</h1>

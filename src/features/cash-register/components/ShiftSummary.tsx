  ...
  return (
    <div className="p-4 hover:bg-zinc-50 transition-colors">
      ...
      <div className="flex justify-between items-baseline">
        <span className="font-medium text-zinc-700 text-base">{movement.concept}</span>
        <span
          ...
          <div className="rounded-lg border border-teal-100 overflow-hidden">
            <div className="px-3 py-2 bg-teal-50 border-b border-teal-100 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-md font-bold text-teal-700">
                  Abonos
                </span>
              </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            {d.shift.notes && d.shift.notes.trim().length > 0 ? (
              <div className="rounded-lg border border-amber-200 bg-[#fffdf5] p-3 flex flex-col justify-center">
                ...
                <p className="text-sm text-amber-800 line-clamp-2" title={d.shift.notes}>
                  {d.shift.notes}
                </p>
              </div>
            ) : (
                 <div className="rounded-lg border border-zinc-100 bg-zinc-50 p-3 flex flex-col justify-center items-center text-zinc-400">

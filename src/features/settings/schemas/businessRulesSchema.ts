...
export const businessSettingsSchema = z.object({
  ...
  defaultCashFund: z.number().min(0, "No puede ser negativo"),
  maxCashLimit: z.number().min(0, "No puede ser negativo"),
  taxRate: z.number().min(0, "Mínimo 0%").max(100, "Máximo 100%"),
  applyTax: z.boolean(),
  allowOutOfStockSales: z.boolean(),
  defaultCreditLimit: z.number().min(0, "El límite base no puede ser negativo"),
  maxCreditLimit: z.number().min(0, "El límite máximo no puede ser negativo"),
